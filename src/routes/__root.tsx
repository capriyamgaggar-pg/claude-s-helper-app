...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Intent is a network for shared real-world goals. Not a feed. Find flatmates, co-founders, trekking groups, travel buddies, and more." },
      { property: "og:title", content: "Intent — find people who share your goal" },
      { property: "og:description", content: "Discover and connect with people who share your real-world intentions." },
